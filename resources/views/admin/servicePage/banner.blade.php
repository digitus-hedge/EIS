...
<div class="wrap">
    <div class="crumbs">
        ...
        <span>&rsaquo;</span>
        <b>Service Banner Section</b>
    </div>

    <div class="header">
        <div>
            <h1>{{ $servicePage->exists ? 'Edit Service Banner' : 'Add Service Banner' }}</h1>
            <p>The title and banner image shown at the top of your Service page.</p>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="field">
                <input type="text" name="banner_title"
                       ...
                       value="{{ old('banner_title', $servicePage->banner_title ?? '') }}"
