    ...
    <form action="{{ route('admin.home.about.store') }}" method="POST" enctype="multipart/form-data" id="aboutForm">
        ...
        <div class="card">
            ...
            <div class="image-slot" style="max-width:300px;">
                <div class="drop img-slot {{ $about->image ? 'filled' : '' }}"    id="drop-image"  data-file-input="file-image" onclick="handleDropClick(this)">
                    @if ($about->image)
        ...
        <div class="card">
            <div class="section-title">
                ...
                <span class="section-sub" id="char-count-msg" style="margin:0;">
                    <span id="char-count">0</span> /1200 characters
                </span>
            </div>
